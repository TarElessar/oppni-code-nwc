...
parfor (i=1:numel(subj_list_for_proc), num_cores) % step through anat-proc, func-proc (block-1)
    ...
    broadcast_aux1.outpath = outpath;
    broadcast_aux1.pipeline_struct = pipeline_struct;
...
parfor (i=1:numel(subj_list_for_proc), num_cores) % step through func-proc (block-2)
    ...
    broadcast_aux2.outpath = outpath;
    broadcast_aux2.pipeline_struct = pipeline_struct;
    broadcast_aux2.MB = MB;
    broadcast_aux2.maskS = maskS;
    broadcast_aux2.maskisnew = maskisnew;
